...
impl Traverser {
    pub fn new(contents_directory_path: PathBuf) -> Self {
        Self {contents_directory_path}
    }

    pub fn traverse_files(&self) -> Result<Vec<Result<PageIndex, OperationResult>>, HugotoJsonError> {
    ...
    fn process_md_toml_front_matter(&self, contents: &str, file_location: &FileLocation) -> Result<PageIndex, OperationResult> {
    ...
    fn process_md_yaml_front_matter(&self, contents: &str, file_location: &FileLocation) -> Result<PageIndex, OperationResult> {
