...
A utility to produce a [Lunr](https://lunrjs.com/) index from a static Hugo site. It's designed to be a modern alternative to the now unsupported [hugo_lunr Node tool](https://www.npmjs.com/package/hugo-lunr).
